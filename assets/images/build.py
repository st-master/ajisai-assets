...
def parse_simple_yaml(yaml_path: Path) -> dict:
    """structure.yaml から title, icon, template を簡易解析"""
...
def main():
    print("🎥 Projector 起動: structure.yaml から index.html を再構築します...")
